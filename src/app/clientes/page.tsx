...
export default function ClientesPage() {
  ...
  // Remove old handleEditClientSubmit function
  ...
  return (
    <Navigation currentTab="clients">
      <main className="flex-1 overflow-y-auto px-md py-lg pb-32 max-w-4xl mx-auto w-full">
            ...
            {filteredClients.map((client) => {
              return (
                ...
                >
                  ...
                  <div className="p-md flex justify-between items-center pl-md">
                    <div>
            ...
            <div className="bg-white w-[90vw] min-w-[320px] max-w-2xl rounded-xl shadow-2xl flex flex-col max-h-[90vh] animate-scale-up" onClick={(e) => e.stopPropagation()}>
              <div className="p-6 overflow-y-auto flex flex-col gap-4">
                ...
                <form onSubmit={handleAddClient} className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-1">
                    <label htmlFor="client-responsible" className="font-label-caps text-label-caps text-on-surface-variant">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="flex flex-col gap-1">
                      <label htmlFor="client-phone" className="font-label-caps text-label-caps text-on-surface-variant">
                        Telefone de Contato
                      </label>
                      <input
                        id="client-phone"
                    ...
                    <div className="flex flex-col gap-1">
                      <label htmlFor="client-email" className="font-label-caps text-label-caps text-on-surface-variant">
                        E-mail de Contato
                      </label>
                      <input
                        id="client-email"
        ...
        {/* Removido o modal antigo de edição de clientes */}
      </main>
    </Navigation>
  );
}
